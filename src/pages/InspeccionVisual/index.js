...
function InspeccionVisual() {
  ...
  return (
    <Container>
      <VergeViewer src="/applications/Aislamiento_y_bloqueo/Aislamiento_y_bloqueo.html" title="Inspeccion Visual" />
      <input
        id="estado_animacion"
        defaultValue="0"
        style={{ display: "none" }}
...
export default InspeccionVisual;
